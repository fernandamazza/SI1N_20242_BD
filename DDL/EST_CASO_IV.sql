...
RAMO_ATIV VARCHAR(100),
DATA_CADASTR_CLI DATE, 
...
MATRICULA_EMPREG INT PRIMARY KEY,
NOME VARCHAR(50) NOT NULL,
TEL_EMPREG VARCHAR(15),
CARGO_EMPREG VARCHAR(70),
SALARIO_EMPREG DECIMAL(10,2),
DATA_ADMISSAO DATE NOT NULL,
QUALIFICACOES_EMPREG TEXT,
CIDADE_EMPREG VARCHAR(50),
ESTADO_EMPREG VARCHAR(50),
PAIS_EMPREG VARCHAR(50),
NUMRUA_EMPREG VARCHAR(10),
BAIRRO_EMPREG VARCHAR(50),
COMPLEMENTO VARCHAR(255)
);
...
ID_COMPONENTES_COD INT,
 rfcCONSTRAINT FK_RS_COMPONENTES FOREIGN KEY (ID_COMPONENTES_COD) REFERENCES COMPONENTES(ID_COMPONENTES)
);

ALTER TABLE CLIENTES ADD UNIQUE (CNPJ);
ALTER TABLE EMPREGADOS ADD UNIQUE (MATRICULA_EMPREGADOS); 
ALTER TABLE EMPRESAS ADD UNIQUE (CNPJ); 
ALTER TABLE FORNECEDORES ADD UNIQUE (CNPJ); 